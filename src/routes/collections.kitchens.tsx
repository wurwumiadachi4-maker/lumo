  ...
  return (
    <CategoryPage
      ...
      guideParagraphs={[
        ...
        "მასალის არჩევაც ერთ-ერთი ყველაზე მნიშვნელოვანი ეტაპია. MDF სამზარეულო გამოირჩევა გლუვი ფასადებით, თანამედროვე დიზაინის შესაძლებლობებითა და ტენიან გარემოში კარგი გამძლეობით, რის გამოც დღეს ერთ-ერთი ყველაზე პოპულარული არჩევანია. ლამინატი შედარებით ეკონომიური ვარიანტია და ხარისხიანი მასალის შემთხვევაში ყოველდღიური გამოყენებისთვისაც ძალიან კარგი არჩევანია. მასივი ხე კი ბუნებრივი ტექსტურითა და გამორჩეული იერით გამოირჩევა, თუმცა უფრო ძვირია და მეტ მოვლას საჭიროებს. ამიტომ უმეტეს შემთხვევაში მომხმარებლები MDF-ს ან ხარისხიან ლამინატს ირჩევენ.",
        "ფერების სწორად შერჩევაც დიდ გავლენას ახდენს სივრცის აღქმაზე. თუ სამზარეულო მცირე ზომისაა, ღია ტონები — თეთრი, კრემისფერი ან ღია ნაცრისფერი — სივრცეს უფრო ნათელსა და ვიზუალურად ფართოს აჩენს. უფრო დიდი სივრცისთვის კი ხშირად ირჩევენ მუქ გრაფიტისფერს, მუქი ხის ტექსტურას ან მათ კომბინაციას, რომელიც თანამედროვე და გამორჩეულ იერს ქმნის. ასევე ძალიან პოპულარულია თეთრისა და ბუნებრივი მუხის ტექსტურის შეხამება — ეს კომბინაცია ინტერიერს სითბოს, სიმყუდროვესა და მინიმალისტურ ელეგანტურობას მატებს.",
        "ბოლო წლებში საქართველოში სულ უფრო პოპულარული ხდება მინიმალისტური სამზარეულოები, სახელურის გარეშე (handle-less) შესრულებული ფასადებით. ასეთი დიზაინი სივრცეს უფრო სუფთა, თანამედროვე და ელეგანტურ იერს აძლევს. Egger-ისა და Kronospan-ის ხარისხიან მასალებს Blum-ისა და Hettich-ის ფურნიტურასთან ერთად ვიყენებთ, რათა სამზარეულომ ყოველდღიურ გამოყენებას წლების განმავლობაში უპრობლემოდ გაუძლოს.",
      ]}
