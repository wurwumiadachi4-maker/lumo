...
function KitchensPage() {
  return (
    <CategoryPage
      ...
      guideParagraphs={[
        "სამზარეულო ერთ-ერთი ყველაზე ხშირად გამოყენებული სივრცეა სახლში, ამიტომ მისი დაგეგმვა მხოლოდ ვიზუალურ მხარეს არ უნდა დაეყრდნოს. კარგად დაპროექტებული განლაგება, ხარისხიანი მასალები და გამძლე ფურნიტურა განსაზღვრავს, რამდენად კომფორტული იქნება მისი გამოყენება წლების განმავლობაში. სწორედ ამიტომ, სამზარეულოს დამზადება ყოველთვის იწყება თქვენი სივრცისა და ყოველდღიური საჭიროებების გაცნობით. მაგალითად, ერთ-ერთი ყველაზე გავრცელებული შეცდომა სამზარეულოს დაგეგმვისას სამუშაო ზონების არასწორი განლაგებაა. მაცივარი, ნიჟარა და ქურა ყოველდღიურად ყველაზე ხშირად გამოიყენება, ამიტომ მათ შორის გადაადგილება მარტივი და მოსახერხებელი უნდა იყოს. სწორად დაგეგმილი განლაგება ამცირებს ზედმეტ მოძრაობას და სამზარეულოს გამოყენებას ბევრად უფრო კომფორტულს ხდის.",
      ]}
      customGuideBody={
        <>
          <MaterialCards
          ...
          <ColorSwatches
            items={[
              { label: "ღია ტონი — პატარა სივრცე", swatchClassName: "bg-sand" },
              { label: "გრაფიტისფერი — დიდი სივრცე", swatchClassName: "bg-foreground" },
              { label: "თეთრი + მუხა — უნივერსალური", swatchClassName: "bg-gradient-to-r from-background to-accent" },
            ]}
          />
