    ...
    <>
      ...
      {!hideMessengerButton && (
        <a
          ...
          className="fixed bottom-24 right-6 z-50 flex items-center gap-2 bg-primary hover:opacity-90 text-primary-foreground px-4 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105 md:bottom-6"
